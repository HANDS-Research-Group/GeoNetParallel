#' Add new water chemistry data and polluting events at existing locations
#' @description This function can be used to add new water chemistry data and polluting events at existing locations and run the statistical inference for all the polluting events. This function can only be used after “whole_pipe” is executed. Execution of this function will overwrite the previously generated output. Therefore, it is advised to preserve a copy of the old outputs in case you need it.
